...
const calculator = async () => {
    ...
    if (operation == "Addition") {
        ...
        console.log(chalk.red(`Difference of first and second number is: ${chalk.green(subtract(num1, num2))}`));
    }
    else if (operation == "Multiplication") {
        console.log(chalk.red(`Product of first and second number is: ${chalk.green(multiply(num1, num2))}`));
    }
    else {
        console.log(chalk.red(`Quotient of first and second number is: ${chalk.green(divide(num1, num2))}`));
    }
